<template>
    <section id="skuSelector">
        <div
            class="overlay"
            v-show="showSkuPicker"
            @click="closeSkuPicker()"
        ></div>
        <div
            :class="['sku_selector_wrapper', showSkuPicker ? 'show_popup' : '']"
        >
            ...
            <div class="sku_selector_container">
                <div class="sku_intro">
                    ...
                    <div class="sku_intro_detail">
                        ...
                        <p class="sku_txt stock">
                            库存：{{ skuMock.sku_stock }}
                        </p>
                        <p class="sku_txt cur_select">
                            已选：{{ curSelect.join(' ') }}
                        </p>
                    </div>
                </div>
                <div class="sku_list_wrapper">
                    <div
                        class="sku_list_container"
                        v-for="(item, key) in skuMock.sku_attr"
                        :key="key"
                    >
                        ...
                        <ul class="sku_list">
                            <li
                                class="sku_item"
                                v-for="(_item, _key) in item.value"
                                :key="_key"
                            >
                                {{ _item }}
                            </li>
